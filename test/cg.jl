...
algo = ExaOpt.HZ()
# res1 = ExaOpt.optimize(algo, aug, u0)

α0 = 1e-0
res2 = @time ExaOpt.ngpa(aug, u0; tol=1e-5, max_iter=2_000, α♯=α0, α_bb=α0)
a1 = aug.counter.objective

u0 = ExaPF.initial(nlp)
res3 = @time ExaOpt.asa(aug, u0; α♯=α0, max_iter=100, gp_tol=1e-4, cg_tol=1e-5)
